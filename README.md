# Drowsiness_Detector
A CV based AI model which detects if the person siting behind the wheel is drowsy or not, and with respect to that, sounds an alarm to prompty wake them up.
